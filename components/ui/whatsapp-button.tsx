...
export function WhatsAppButton() {
  ...
  return (
    <motion.a
      ...
      className={`fixed bottom-8 right-8 z-50 flex items-center gap-3 px-4 py-3 border-2 border-black rounded-none font-mono text-xs uppercase tracking-widest transition-colors duration-0 ${
