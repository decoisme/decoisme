...
// Demo profile ID (from SETUP_PROFILE_SIMPLE.sql)
...
export function AboutSectionProfileDemo() {
  ...
  const loadProfile = async () => {
    ...
    if (!supabase) {
      console.log('Supabase not configured, using default profile');
      setProfile({
        id: DEMO_PROFILE_ID,
        user_id: 'demo-user-123',
        full_name: 'Decoisme',
        bio: 'Passionate UI/UX Designer & Creative Professional. Specializing in Instagram feed design, carousel posts, and brand identity.',
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          >
            ...
            <button
              ...
              className="mt-6 px-4 py-2 rounded-full bg-gradient-to-r from-yellow-600 to-amber-600 hover:from-yellow-700 hover:to-amber-700 text-white text-sm font-medium transition-all shadow-lg hover:shadow-xl"
            >
              {isEditing ? '✓ Done Editing' : '✏️ Edit Profile Picture'}
            </button>
          </motion.div>
