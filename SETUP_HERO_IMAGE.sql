-- ============================================
-- SETUP HERO IMAGE STORAGE
-- ============================================

-- 1. Create storage bucket for hero images (if not exists)
INSERT INTO storage.buckets (id, name, public)
VALUES ('hero-images', 'hero-images', true)
ON CONFLICT (id) DO NOTHING;

-- 2. Set up storage policies for hero images
...
-- 3. Create hero_settings table to store hero image URL
...
-- NOTES
-- ============================================
-- 1. Hero image will be stored at: hero-images/hero-[timestamp].[ext]
-- 2. Public URL format: https://[project-ref].supabase.co/storage/v1/object/public/hero-images/[filename]
-- 3. Recommended image specs:
--    - Format: JPG, PNG, or WebP
--    - Max size: 5MB
--    - Recommended dimensions: 800x800px (square) or 600x800px (portrait)
--    - Aspect ratio: 1:1 or 3:4
-- 4. Only one hero settings record (singleton pattern)
